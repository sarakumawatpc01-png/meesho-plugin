<?php $settings = new Meesho_Master_Settings(); $site_id = $settings->get( 'hotjar_site_id' ) ?: $settings->get( 'mm_hotjar_id' ); ?>
...
<div id="rankings_list" class="mm-mt-10"><p class="mm-text-muted">Tracked keywords will appear here.</p></div>
<?php else : ?>
